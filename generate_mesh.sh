...
balsam "$MODEL_DIR/bot/blue/rigid_body/frame.obj" -o "$MODEL_DIR/bot/blue/rigid_body/"
# balsam "$MODEL_DIR/bot/blue/viz/body/frame.obj" -o "$MODEL_DIR/bot/blue/viz/body/"
...
# balsam "$MODEL_DIR/bot/yellow/rigid_body/body/body.obj" -o "$MODEL_DIR/bot/yellow/rigid_body/"
...
# find "$MODEL_DIR/bot/yellow/rigid_body/body/meshes" -name "*.mesh" -exec cooker {} \;
